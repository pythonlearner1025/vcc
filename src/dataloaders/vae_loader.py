"""
DataLoaders for VAE training on single-cell RNA-seq data.

This module implements dataloaders for the two-phase VAE training approach:
1. Phase 1: Pretraining on large scRNA-seq datasets (control cells only)
2. Phase 2: Fine-tuning on paired control/perturbation data
