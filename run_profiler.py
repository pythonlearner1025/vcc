...
from train import train_epoch_st, ConditionalModelConfig        # your code
from models.diffusion import PartialMaskingDiffusion            # your code
...
dummy_tokens = torch.randint(0, config.vocab_size, (8, 2000))          # 8 cells, 256 tokens
...
with profile(activities=activities,
    ...
    for step, batch in enumerate(loader):
        global_step = train_epoch_st(
            model, diffusion, loader, opt, config,
